...
def read_img(path):
    ...
    imgs=[]
    labels=[]
    for idx,floder in enumerate(cate):
...
def inference(input_tensor,train,regularizer):
    with tf.variable_scope('layer1-conv1'):
        ...
        con1_biases=tf.get_variable("bias",[32],initializer=tf.constant_initializer(0.0))
    ...
    with tf.variable_scope("layer11-fc3"):
        ...
        fc3_biases=tf.get_variable("bias",[5],initializer=tf.constant_initializer(0.0))
